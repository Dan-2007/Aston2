package org.example.emailnotificationservice.handler;

import org.example.events.UserCreatedEvent;
import org.example.events.UserDeletedEvent;
import org.example.emailnotificationservice.exception.NonRetryableException;
...
public class UserEventsHandler {
    ...
    public void handle(UserCreatedEvent userCreatedEvent){
        ...
        try {
            ...
            log.error("Error while sending email notification occurred: {}", e.getMessage());
